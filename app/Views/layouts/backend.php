...
<head>
    ...
    <meta name="description" content="<?= APP_NAME ?> Aplikasi Kasir Warung dibuat Oleh <?= COMPANY_NAME ?>">
...
<body>
    ...
    <div id="app">
        ...
        <v-app>
            ...
            <v-navigation-drawer v-model="sidebarMenu" color="indigo" dark app floating :permanent="sidebarMenu" :mini-variant.sync="mini" v-if="!isMobile">
                <v-list dense>
                    <v-list-item>
                        <v-list-item-action>
                ...
                <v-list>
                    ...
                    <v-list-item-group>
                        ...
                        <?php if (session()->get('role') == 2) : ?>
                            ...
                            <v-list-item link href="<?= base_url('penjualan'); ?>" <?php if ($uri->getSegment(1) == "penjualan") : ?><?= 'class="v-item--active v-list-item--active"'; ?><?php endif; ?> title="<?= lang('App.receipt') ?>" alt="<?= lang('App.receipt') ?>">
                                <v-list-item-icon>
                                    <v-icon>mdi-receipt-text</v-icon>
                                </v-list-item-icon>
                                <v-list-item-content>
                                    <v-list-item-title><?= lang('App.receipt') ?></v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
            ...
            <v-container>
                <p class="text-center text-caption mb-0">
                    &copy; {{ new Date().getFullYear() }} <?= COMPANY_NAME ?> Software <?= APP_VERSION ?> All rights reserved
                </p>
            </v-container>
