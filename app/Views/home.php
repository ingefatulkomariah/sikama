    ...
    <v-container class="indigo lighten-5" fluid>
        <div class="pt-7">
            <v-row align="center" justify="center">
                <v-col cols="11">
                    <v-text-field color="indigo" v-model="pencarian" v-on:keydown.enter="cariBarang" label="Scan Barcode" prepend-inner-icon="mdi-magnify" :autofocus="true" height="60" solo :loading="loading" loader-height="3" hide-details append-icon="mdi-camera" @click:append="dialogCameraOpen" ref="inputRef"></v-text-field>
