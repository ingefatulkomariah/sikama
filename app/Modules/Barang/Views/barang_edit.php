...
<template>
    <v-card>
        <v-toolbar elevation="1">
            ...
            <v-spacer></v-spacer>
            <v-btn color="indigo" dark large @click="updateProduct" :loading="loading">
        ...
        <v-card-text>
            <v-form ref="form" v-model="valid">
                ...
                <v-row class="mt-n4">
                    ...
                    <v-col cols="12" md="9">
                        <v-text-field v-model="hargaBeli" label="<?= lang('App.priceBuy') ?> *" type="number" :error-messages="harga_beliError" prefix="Rp" outlined dense></v-text-field>
                        
                        <v-text-field v-model="hargaJual" label="<?= lang('App.priceSell') ?> *" type="number" :error-messages="harga_jualError" prefix="Rp" :suffix=" untungPersen.toFixed() + '% untung'" outlined dense></v-text-field>
