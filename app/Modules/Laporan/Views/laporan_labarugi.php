...
<v-card>
    ...
    <v-card-text class="pt-0">
        <v-list class="pt-0">
            ...
            <v-list-item class="ms-7">
                <v-list-item-content>
                    <v-list-item-title>Pengeluaran &amp; Biaya</v-list-item-title>
                </v-list-item-content>
                <v-spacer></v-spacer>
                <h3 class="font-weight-regular">{{Ribuan(pengeluaran ?? "0")}}</h3>
            </v-list-item>
            <v-divider></v-divider>
            <v-list-item class="ms-7">
                <v-list-item-content>
                ...
                <v-spacer></v-spacer>
                <h3 class="font-weight-regular">{{Ribuan(pengeluaranLain ?? "0")}}</h3>
            </v-list-item>
            <v-divider></v-divider>
            <v-list-item>
                <v-list-item-content>
                ...
                <v-spacer></v-spacer>
                <h3 class="font-weight-regular">{{Ribuan(totalPengeluaran ?? "0")}}</h3>
            </v-list-item>
        </v-list>
    </v-card-text>
</v-card>
