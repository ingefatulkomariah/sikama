...
class LaporanNotaitemModel extends Model
{
    ...
    {
        $this->select("p.faktur, p.subtotal, p.diskon, p.diskon_persen, p.total, {$this->table}.qty, {$this->table}.jumlah, {$this->table}.satuan, b.id_barang, b.nama_barang, {$this->table}.created_at");
