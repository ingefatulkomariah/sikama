...
class LaporanBarangModel extends Model
{
    ...
    public function getLaporanByBarang($start, $end)
    {
        ...
        $this->select("{$this->table}.*, bi.kode_barang, b.nama_barang, b.barcode, b.sku, b.stok, m.media_path, k.nama_kategori");
        $this->join("barang b", "b.id_barang = {$this->table}.id_barang");
        $this->join("barang_item bi", "b.id_barang = {$this->table}.id_barang");
