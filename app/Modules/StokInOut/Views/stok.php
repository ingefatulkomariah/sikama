...
<template>
    ...
    <v-card>
        <v-card-title>
            <v-btn large color="indigo" dark @click="modalAddOpen" class="mr-3" elevation="1">
            ...
            <v-card>
                ...
                <v-card-text class="py-5">
                    ...
                    <v-form v-model="valid" ref="form">
                        ...
                        <div v-else>
                            <v-text-field v-model="scan" prepend-inner-icon="mdi-magnify" label="Scan Barcode" placeholder="" v-on:keydown.enter="scanBarang" class="mb-3" outlined hide-details clearable autofocus :autofocus="'autofocus'"></v-text-field>
                        </div>
