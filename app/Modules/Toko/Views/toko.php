                    ...
                    <v-form ref="form" v-model="valid">
                        <v-row>
                            <v-col cols="12" sm="6" class="mb-n5">
                                <p class="mb-2 text-subtitle-1"><?= lang('App.name'); ?> Warung/Toko</p>
                        ...
                        <p class="mb-2 text-subtitle-1"><?= lang('App.address'); ?> Warung/Toko</p>
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" sm="3" class="mb-n4">
                                ...
                                <v-text-field v-model="nib" :error-messages="NIBError" hint="Nomor Induk Berusaha" dense outlined></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="3">
        ...
        <v-tab-item>
            <v-card outlined>
                ...
                <v-card-text class="elevation-1">
                    <v-list-item>
                        <v-list-item-icon>
                            <v-switch v-model="kodeJualTahun" value="kodeJualTahun" false-value="0" true-value="1" color="primary" @click="setAktifKodeJualTahun" inset></v-switch>
                        </v-list-item-icon>
                        <v-list-item-content>
                            <v-list-item-title>
                    ...
                    <v-list-item>
                        <v-list-item-icon>
                            <v-switch v-model="scanKeranjang" value="scanKeranjang" false-value="0" true-value="1" color="primary" @click="setAktifScanKeranjang" inset></v-switch>
                        </v-list-item-icon>
                        <v-list-item-content>
                            <v-list-item-title>
        ...
        <v-tab-item>
            <v-card outlined>
                ...
                <v-card-text class="elevation-1">
                    ...
                    <v-row>
                        <v-col cols="12" sm="9">
                            <v-select v-model="paper" name="role" :items="paperSize" item-text="label" item-value="value" label="Select" outlined single-line @change=""></v-select>
                        </v-col>
                        <v-col cols="12" sm="3">
